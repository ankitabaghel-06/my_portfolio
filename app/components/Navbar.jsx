        ...
        <>
            ...
            <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50
                ...
                ${isScroll ? "" : " bg-white/50 shadow-sm dark:border dark:border-white/50 dark:bg-transparent "}`}>
                    ...
                    <li><a href="#projects" className='font-Ovo'>Tech-Stack</a></li>
                    <li><a href="#exp" className='font-Ovo'>Work</a></li>
                ...
                ${isDarkMode ? "bg-[#2a004a] text-white" :"bg-rose-50"}`}>
                    ...
                    <li><a href="#projects" onClick={closeMenu} className='font-Ovo'>Tech-Stack</a></li>
                    <li><a href="#exp" onClick={closeMenu} className='font-Ovo'>Work</a></li>
